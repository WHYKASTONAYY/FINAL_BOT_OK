...
from utils import (
    ...
    SECONDARY_ADMIN_IDS, PRIMARY_ADMIN_IDS, is_primary_admin, is_secondary_admin, is_any_admin,
...
async def handle_admin_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, params=None):
    ...
    user_id = user.id
    chat_id = update.effective_chat.id
    is_primary = is_primary_admin(user_id)
    is_secondary = is_secondary_admin(user_id)
